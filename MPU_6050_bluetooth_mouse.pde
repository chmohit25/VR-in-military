...
try{ port = new Serial(this,"com4",9600); //com= arduino com (Arduino ide -> Tool -> Port:"comX"
...
if (pointer[3]==1)
mouse.mousePress(InputEvent.BUTTON3_MASK); // left mouse click
else if (pointer[3]==0)
mouse.mouseRelease(InputEvent.BUTTON3_MASK ); // left mouse release
}
